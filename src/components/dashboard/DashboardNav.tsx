        ...
        <AnimatePresence>
          {isOpen && (
            <>
              ...
              {/* PREMIUM SIDEBAR CONTROL DRAWER - MOUNTED DIRECTLY TO BODY ROOT TO ENFORCE SOLID BG */}
              <motion.div 
                initial={{ x: "-100%" }}
                animate={{ x: 0 }}
                exit={{ x: "-100%" }}
                transition={{ type: "spring", damping: 24, stiffness: 180 }}
                className="fixed inset-y-0 left-0 w-full max-w-[320px] bg-black border-r border-neutral-900 z-[10000] flex flex-col justify-between p-6 shadow-[25px_0_60px_rgba(0,0,0,1)] text-white"
              >
                <div>
